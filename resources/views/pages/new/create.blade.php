...
<div class="wrapper">
   <div class="main-container col1-layout">
      ...
      <div class="customer-service" data-modal-id="customer-care">
         ...
         <section>
            <h4 class="section-title">Input details for new item. The system will handle the rest &#9786;</h4>
            <form data-action="#" id="contactForm" method="POST" action="{{ route('new.store') }}" enctype="multipart/form-data" class="form">
               {{ csrf_field() }}
